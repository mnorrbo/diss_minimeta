...
#labels for plot
supp.labs <- c('no' = "Used internal meta-analysis", 'yes' = "Did not use internal meta-analysis")

g1 <- ggplot(tidydat, aes(x=PVALNO, y=PVALUES)) +
  geom_point(aes(colour = STUDY_ID), size = 2) +
  geom_line(aes(group = STUDY_ID, colour = STUDY_ID), size = 2) + 
...
ggsave("pvalueplot.png", width = 10, height = 7)
